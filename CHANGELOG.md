...
* add API to get a list of all available models ([#1160](https://github.com/forgotDj/puter/issues/1160)) ([004e47a](https://github.com/forgotDj/puter/commit/004e47a4a9693e625425348c48f3fe3e4ebccd66))
* add costly model to FakeChatService ([42c6f92](https://github.com/forgotDj/puter/commit/42c6f920481208c6e0bdf7a8d926ad5edd287bd7))
* add public endpoint for models list ([#1228](https://github.com/forgotDj/puter/issues/1228)) ([45c072f](https://github.com/forgotDj/puter/commit/45c072ff93aeeb58a3680f23c53d3f15651b6fd2))
* add startup chime feature ([3d3af13](https://github.com/forgotDj/puter/commit/3d3af1397902e37a3ca2760eac31fa7f02da5170))
* **aws/polly:** add new apis to puter-js, add new args to txt2speech ([#1337](https://github.com/forgotDj/puter/issues/1337)) ([0b6dbe5](https://github.com/forgotDj/puter/commit/0b6dbe587a943f3b283be382fc12690034ec26c0))
* button to remove profile image [#1245](https://github.com/forgotDj/puter/issues/1245) ([#1246](https://github.com/forgotDj/puter/issues/1246)) ([dad72c5](https://github.com/forgotDj/puter/commit/dad72c5bd709ed5e176c6c82ef4c64eaeb78f92f))
* captcha ([ad4b3e7](https://github.com/forgotDj/puter/commit/ad4b3e7aeb9d42c48b2cce8c12f4790d83464235))
* create and export UsageLimitedChatService  ([#1182](https://github.com/forgotDj/puter/issues/1182)) ([bf3d63a](https://github.com/forgotDj/puter/commit/bf3d63a083838c7f7002d7d6e483f55e95587657))
* enhanced ai command to perfom other commands ([#1156](https://github.com/forgotDj/puter/issues/1156)) ([7ed779b](https://github.com/forgotDj/puter/commit/7ed779bbf384a2a559b642c553ec2c0e0de02ada))
* essential configuration options for deployers ([3666b9f](https://github.com/forgotDj/puter/commit/3666b9f3a25127909940c988164ff61ec3c2ea99))
* GUI Permission Dialog ([#1177](https://github.com/forgotDj/puter/issues/1177)) ([3cdbcd8](https://github.com/forgotDj/puter/commit/3cdbcd83b33362a3ad731ebb593a58dade1875bc))
* **gui:** Add animation effects to the taskbar ([#1365](https://github.com/forgotDj/puter/issues/1365)) ([212bc88](https://github.com/forgotDj/puter/commit/212bc88c8f7561a7b1dc9bac3d5308ec2275c8e1))
* implement authentication UI in Puter.js's test UI ([3def1d4](https://github.com/forgotDj/puter/commit/3def1d4d7c03f784f26edbb802f2478aa16f0eea))
* implement settings management and modal in puter.js test framework ([9ca1f06](https://github.com/forgotDj/puter/commit/9ca1f0639a92a0ea5ce43081a4f43e33b02dc08f))
* puter workers ([bddc872](https://github.com/forgotDj/puter/commit/bddc872e009abecffc8517a55d5222025fc113e7))
* show/hide desktop icons option in context menu ([b0efff7](https://github.com/forgotDj/puter/commit/b0efff7a4f656cd180ccfadd98609ef37e1155dd))
* UIAlert with dynamic icon types and default button configurations ([#1175](https://github.com/forgotDj/puter/issues/1175)) ([a278a61](https://github.com/forgotDj/puter/commit/a278a6140bab32fddbf44226f551765481f7b8d9))


### Bug Fixes

* .startsWith on undefined ([9a12db2](https://github.com/forgotDj/puter/commit/9a12db2066abbcccd2aa2626406d308c23725af6))
* 1231 ([9a84776](https://github.com/forgotDj/puter/commit/9a847760bceefcd13f174bebfdc1ecd5708fa5be))
* add _init method to register FakeChatService as a provider ([7a2851d](https://github.com/forgotDj/puter/commit/7a2851d2ccfcba05aa0270bbb4a61386a98a91a3))
* add missing null check ([89b8c8d](https://github.com/forgotDj/puter/commit/89b8c8de1dfe9a36b8aef675852821c5ca61b71b))
* add missing unit conversion step ([4b5955b](https://github.com/forgotDj/puter/commit/4b5955b45963711bc5d19b0f242971b39be1b058))
* add necessary supporting code for funding update ([1c19086](https://github.com/forgotDj/puter/commit/1c1908659262ff1ae7a89191b5adc6c025bd5e98))
* add one I missed previous commit ([5b7b524](https://github.com/forgotDj/puter/commit/5b7b52408003c173ec21aa74f5eb756ecf8d77cd))
* add safeguard in case server response is wrong ([cbfb928](https://github.com/forgotDj/puter/commit/cbfb9283d10f248976d28f8ab55b5d1c83ca1980))
* add support for new Endpoint usage ([db960d5](https://github.com/forgotDj/puter/commit/db960d585a244716e683ac726b25c5e3aba57f95))
* alerts being completely broken ([33a7811](https://github.com/forgotDj/puter/commit/33a7811e8f17ad642dc41455d82bc8e298945c42))
* allow command provider to not implement complete method ([2000b89](https://github.com/forgotDj/puter/commit/2000b8909f08d91147b86fce22fe006e0c3152d2))
* allow fake-chat to report usage for costly model ([617fb49](https://github.com/forgotDj/puter/commit/617fb491789b237e43c29ccb62ce05cef2bcebee))
* arrow key navigation ([ae07a5e](https://github.com/forgotDj/puter/commit/ae07a5e316a16cfff281c25f9b4674f24fe93b65))
* arrow keys unresponsive when selecting items with offset center points ([5fd5017](https://github.com/forgotDj/puter/commit/5fd50170801813e29e6c309d0f4e840cf7506eef))
* async handling for events ([d0edb2c](https://github.com/forgotDj/puter/commit/d0edb2c1f3c2dd28d3adcaec163af026e7fa4fcc))
* broken model parameter ([27fd7b3](https://github.com/forgotDj/puter/commit/27fd7b3670343ebe03efae0e1521f385d5d4d566))
* broken test in putility ([a803d55](https://github.com/forgotDj/puter/commit/a803d55cfbdd5b15e7fe48df3f4363c1658f0930))
* build error ([5f14dc7](https://github.com/forgotDj/puter/commit/5f14dc720be1583f33d9da23bbc59167b0635d8c))
* cannot create shortcut for shared file ([72a4550](https://github.com/forgotDj/puter/commit/72a45500d5db68215e1d6c9638a8c629acff9e2d)), closes [#1263](https://github.com/forgotDj/puter/issues/1263)
* check funding with no args ([f0c0693](https://github.com/forgotDj/puter/commit/f0c06931bd4feae5860b365427fabc3ba253bbe1))
* clarify variable names in puter.ai.chat method ([6a3b20f](https://github.com/forgotDj/puter/commit/6a3b20f0a89575fc770e605d78323fcf48808a0e))
* cleanup example so bots don't flag it ([868ef4e](https://github.com/forgotDj/puter/commit/868ef4e5a4ba1429e048a76454d586edb3c81629))
* complete Norwegian Nynorsk translation ([807d7bd](https://github.com/forgotDj/puter/commit/807d7bd698a75f011cbbb1df1de3322701088727))
* consistent email check in confirm-email ([c254b39](https://github.com/forgotDj/puter/commit/c254b39afe4855ab3b329fd182b73bd2e99fc61d))
* cost testing model ([f46d47d](https://github.com/forgotDj/puter/commit/f46d47d2a8fefee01f1b5570018a6b5c4144e83d))
* dev-center undefined error ([794778d](https://github.com/forgotDj/puter/commit/794778d665b0ae6dfa92b727a5f88fc604e982cd))
* don't show register when user signup is disabled ([ad7b7b9](https://github.com/forgotDj/puter/commit/ad7b7b951345bb23c9010c8e3509673412c5d6d3)), closes [#1087](https://github.com/forgotDj/puter/issues/1087)
* edge case during email change ([fb01bb4](https://github.com/forgotDj/puter/commit/fb01bb474aecb4625fbd840436ae4781f86b4cf6))
* enable and fix date command tests ([d885ea5](https://github.com/forgotDj/puter/commit/d885ea5772b9aab6dce3092139309df79753d701)), closes [#796](https://github.com/forgotDj/puter/issues/796)
* error handling error in UIWindowSignup ([6451f1b](https://github.com/forgotDj/puter/commit/6451f1b4e914c2831647ac2b269b224d784325da))
* error handling in ThreadService ([95ddfe3](https://github.com/forgotDj/puter/commit/95ddfe3909d3279e9a767febda7670cdb8cc3d3b))
* errors after stream starts ([759c32a](https://github.com/forgotDj/puter/commit/759c32ac726461202323d97309828160cd6dc1a0))
* fallback behavior related to fake-chat service ([9bf48e7](https://github.com/forgotDj/puter/commit/9bf48e7289cef34b0f1527a5dc0792a7ebf14710))
* file cleanup for Claude when streaming ([50d520f](https://github.com/forgotDj/puter/commit/50d520f09935f34bad6420ec8c8373ba2ed7e13c))
* file manager sidebar headings contrast ([#1191](https://github.com/forgotDj/puter/issues/1191)) ([dab5e0a](https://github.com/forgotDj/puter/commit/dab5e0a281c1749ef969d0eefb45b39fda8ce496))
* fix previous fix ([e5c3769](https://github.com/forgotDj/puter/commit/e5c3769bd813b1510dd0429e1e4eca8e277af7c7))
* get event docs back in sync ([e6b3cb3](https://github.com/forgotDj/puter/commit/e6b3cb36665b51c5b7cc88f13513bf71c36a4f3a))
* get sharp far away from bundlers as possible ([963b248](https://github.com/forgotDj/puter/commit/963b248582a8d2aec67261ca171d48076575b84d))
* gone ([34787bb](https://github.com/forgotDj/puter/commit/34787bbb0cfc08dc9e35128ed6549c18709d60a1))
* **gui:** clock padding moving other elements ([8edcf75](https://github.com/forgotDj/puter/commit/8edcf7575d242e30b6c88eb1e9f91c3017835f6c))
* **gui:** color of the UI on dark mode (e.g. windows control, active sidebar) ([#1161](https://github.com/forgotDj/puter/issues/1161)) ([33c3048](https://github.com/forgotDj/puter/commit/33c304879a5fe4db6f0be10fce87629d40db31b1))
* **gui:** logo placement with no clock using margin ([5c50eb1](https://github.com/forgotDj/puter/commit/5c50eb1f8bbb5eb9e9ef9e529f82d1b953fd7e84))
* handle all temp user errors by reloading ([0347a38](https://github.com/forgotDj/puter/commit/0347a38136861288cdac8ed35d90c2a428ba2d98))
* handle problematic null or undefined case ([b7efa6f](https://github.com/forgotDj/puter/commit/b7efa6f89431836bcd1292d495ba010c2933d9dd))
* how did this get here ([f2305ff](https://github.com/forgotDj/puter/commit/f2305ff2896dd65787aa9bda232df15e4e424f2b))
* iframe overlap issue (PR 1250) ([284b89a](https://github.com/forgotDj/puter/commit/284b89a5fd497fc598b2ed2683d7997b3e0094a4)), closes [#1233](https://github.com/forgotDj/puter/issues/1233)
* improvements to jaeger trace service ([fd956cb](https://github.com/forgotDj/puter/commit/fd956cb1cd23d28b935c3693c29c10208845261f))
* include base reserved words by default ([c7970fd](https://github.com/forgotDj/puter/commit/c7970fd1a830dfcbe0e031007bceafeb97bb8084))
* incorrect addition of https prefix for peers ([41d5dbc](https://github.com/forgotDj/puter/commit/41d5dbc0da771ecab47cd477a5ed91b3f65709db))
* incorrect call to APIError from configurable_auth ([5903f1f](https://github.com/forgotDj/puter/commit/5903f1fb31eb1cbbcb0d346ebefc716c9d6e68ad))
* incorrect pricing ([ae4dc23](https://github.com/forgotDj/puter/commit/ae4dc23c378c624bd6aa76bd45d201d476445a25))
* install ([2d9526b](https://github.com/forgotDj/puter/commit/2d9526ba404bead5beaa87c86712dee4984b28dc))
* issue using ll_write outside of hl_write ([152a557](https://github.com/forgotDj/puter/commit/152a5578fce30dff0c183db81b52fc8332947a52))
* issues with thread subscriptions ([252647c](https://github.com/forgotDj/puter/commit/252647cea6c2202a2a2ba61f9e026189810ef889))
* made protocol dynamic in the publishURL displayed on 'Publish As Website' dialogbox ([#1170](https://github.com/forgotDj/puter/issues/1170)) ([6236d00](https://github.com/forgotDj/puter/commit/6236d00ea2324a8c4e05a57181d0d2318f33584e))
* make sharp optional ([354b116](https://github.com/forgotDj/puter/commit/354b116b424243fac989009612b0e457d0e54e8c))
* message coercion bug affecting vision ([ec0a721](https://github.com/forgotDj/puter/commit/ec0a72114382a78d82bc7d0156daf1a2a003d567))
* message coercion for tool call message ([d66e38c](https://github.com/forgotDj/puter/commit/d66e38cc667073603d4368095d4e0bc277218f90))
* move AppCommandProvider to the end ([870e4aa](https://github.com/forgotDj/puter/commit/870e4aa93807f1fcd37af29d9369737ab9f4b4b1))
* necessary updates happen for move save too ([6598798](https://github.com/forgotDj/puter/commit/659879812dcf77578103e58d8b9f667c91a8c589))
* npm install error on Windows (spawn EINVAL) ([#1214](https://github.com/forgotDj/puter/issues/1214)) ([4b7e09e](https://github.com/forgotDj/puter/commit/4b7e09e1570c140fa9f0a02fbe9a47e4fc7ad69f))
* o3 tools with array parameters ([2ee380e](https://github.com/forgotDj/puter/commit/2ee380ec16789525c9f0b782fb4af1e193ddd232))
* oops, no export (putility.libs.event) ([fa4b38c](https://github.com/forgotDj/puter/commit/fa4b38cd028be4b19ec98bcf588227e0fc92af9d))
* parse body before auth for /down ([70fde95](https://github.com/forgotDj/puter/commit/70fde95255532a7fe0d99c64a4efb1ae625776a4))
* pass dedupe_name to mkshortcut via batch ([cecc9f2](https://github.com/forgotDj/puter/commit/cecc9f23dca4f07b289355d74b60db626871c931))
* path update in legacy rename behavior ([7e82c94](https://github.com/forgotDj/puter/commit/7e82c947b1070b4a42798f7ae84bfaee8c3b54c9))
* permission request 500 errors ([3276faa](https://github.com/forgotDj/puter/commit/3276faa5f09163a924316fac1a175ddeb0724e61))
* phoenix changelog ([0bcbc8f](https://github.com/forgotDj/puter/commit/0bcbc8f7845de99305f53c6da2bb1f365b87ac50))
* potential fix for /down auth ([390230c](https://github.com/forgotDj/puter/commit/390230c5a07b1774f84a1b3505f7531ce81dc2cc))
* potential log error ([f7b302b](https://github.com/forgotDj/puter/commit/f7b302b024ee631794ae6d3a162641bc76924dde))
* prevent health check from surpressing traces ([2cd5b3c](https://github.com/forgotDj/puter/commit/2cd5b3cb498ca5511b0120b4a007512837e1558f))
* properly update owner object in FSNodeContext ([d17b466](https://github.com/forgotDj/puter/commit/d17b466e37eb153bfd0ec3256ed040d0fa4e5291))
* put guard around startup chime ([a276a82](https://github.com/forgotDj/puter/commit/a276a82e443e88e327d80db0c53f902a885696bb))
* puter subdomain error response ([cfa5c7e](https://github.com/forgotDj/puter/commit/cfa5c7e715405a0f92dc798195edc25f66b2b83b))
* puter.js threads error handling ([fc11eba](https://github.com/forgotDj/puter/commit/fc11eba070cb97736d7d464fcc04777235aeb06b))
* recursive delete error ([7e76b65](https://github.com/forgotDj/puter/commit/7e76b657bb2fe811d437598471e52744a6276088))
* redundant report-usage call in FakeChatService ([0201b93](https://github.com/forgotDj/puter/commit/0201b9301394f2f4cfa9908071ced7c54018e7c3))
* remaining issues with fake-chat/costly ([7f6b302](https://github.com/forgotDj/puter/commit/7f6b3026364b6c4dee8e622aaeec1d039e3ac054))
* remove dormant condition operand from signup.js ([a7d1bf0](https://github.com/forgotDj/puter/commit/a7d1bf0e99931f5dda5ec5ed0b3e894b54c82e0d))
* remove duplicate icons and hide .weblink extension ([bf16e20](https://github.com/forgotDj/puter/commit/bf16e2044737001423e7c12c2105878c36aa9e35))
* reposition clock to right ([#1181](https://github.com/forgotDj/puter/issues/1181)) ([505e7ab](https://github.com/forgotDj/puter/commit/505e7abda2df6109b1e322595c8442719403757f))
* return proper error message when the model is not found ([#1331](https://github.com/forgotDj/puter/issues/1331)) ([ade213b](https://github.com/forgotDj/puter/commit/ade213b88b82d44139c54ed55992745379d78548)), closes [#1326](https://github.com/forgotDj/puter/issues/1326)
* save_account lock timeout ([ccdb678](https://github.com/forgotDj/puter/commit/ccdb678937b9742e30061ae39fb7c710389f720c))
* **security:** patch express via path-to-regexp ([d081c4f](https://github.com/forgotDj/puter/commit/d081c4f2fe8357ef8aa35790a794509a8e188fb7))
* share issue ([518449c](https://github.com/forgotDj/puter/commit/518449cfdd1e3ccb8240a8865069e2bb524f8725))
* shortcut KV permissions ([f6e6e8d](https://github.com/forgotDj/puter/commit/f6e6e8dff829eb86a4bfa7129f01e4c0b18517db))
* small fixes for threads ([96199cb](https://github.com/forgotDj/puter/commit/96199cbb54c8e4cbe3205a507de606811e893130))
* sqlite syntax inconsistency ([75aebd6](https://github.com/forgotDj/puter/commit/75aebd6d35f97ff376fc393498031993ba9707b3))
* streaming in FakeChatService ([2e90e8d](https://github.com/forgotDj/puter/commit/2e90e8dc960fb18abe3f2120a78df3ddc9085093))
* sure, but how 'bout a logo that isn't broken ([f80105a](https://github.com/forgotDj/puter/commit/f80105af6d3561d6cceab81e18a7b56ad2f29867))
* temperature and max_tokens (interface + OpenAI) ([03045e2](https://github.com/forgotDj/puter/commit/03045e2737084b838323c49bef8cebc8e9e39a27))
* thread delete events ([3e74f42](https://github.com/forgotDj/puter/commit/3e74f42c4d1c0519e4e89d939b4af416ce008737))
* thread subscription updates across regions ([76bedf5](https://github.com/forgotDj/puter/commit/76bedf5f8ff3167eb6bf5ff71f7cc06c74f62d23))
* ui bug in settings window ([77f3bf2](https://github.com/forgotDj/puter/commit/77f3bf21770d26b82be32b110ebd4b880e6d348b))
* update check_usage_ to only consider past month usage ([#1209](https://github.com/forgotDj/puter/issues/1209)) ([67a898e](https://github.com/forgotDj/puter/commit/67a898ea33b22a8ffd2a799001e6e149bdacc3d4))
* update package-lock.json ([60a9be1](https://github.com/forgotDj/puter/commit/60a9be12badd168446bd8a416cc67dd2c50487a8))
* update package.json ([c2c5d88](https://github.com/forgotDj/puter/commit/c2c5d883365ae33749709d11e0c2de9050ca144e))
* update refresh_actor cache invalidation ([405564f](https://github.com/forgotDj/puter/commit/405564f55fb9ba3b3bcac67774b12d16a69e9724))
* use correct path for openrouter max tokens ([3f5de6d](https://github.com/forgotDj/puter/commit/3f5de6d493f7de34e1f2b7924c29d36f97dd14e8))
* use event service ([dc2e406](https://github.com/forgotDj/puter/commit/dc2e406cc68ec1c879f4c57038cf356b66190b0f))
* **ux:** Make it easier to add file extensions to an app in bulk ([#1205](https://github.com/forgotDj/puter/issues/1205)) ([1266ef2](https://github.com/forgotDj/puter/commit/1266ef217902effc8feb3d1c17d9f2e50e7e0856))
* various AI fixes ([4312280](https://github.com/forgotDj/puter/commit/43122801bf9dc207843e95fa2f881ff212763b36))
* wrong parameter count ([26591e4](https://github.com/forgotDj/puter/commit/26591e4171d41f402efa78201dd5308ec419b26c))
* wrong symbol in previous commit ([ca3acf1](https://github.com/forgotDj/puter/commit/ca3acf13c14db089f7ce601de38f470e59988f89))
